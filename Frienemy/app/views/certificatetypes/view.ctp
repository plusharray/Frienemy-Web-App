...
<h2><?php __('certificatetype_detail_information'); ?></h2>

<dl>
	<dt class="altrow"><?php __("certificatetypeid"); ?></dt>
	<dd class="altrow"><?php echo $certificatetype['Certificatetype']['certificatetypeid']; ?>&nbsp;</dd>
	<dt><?php __("id"); ?></dt>
	<dd><?php echo $certificatetype['Certificatetype']['id']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("certificatetypename"); ?></dt>
	<dd class="altrow"><?php echo $certificatetype['Certificatetype']['certificatetypename']; ?>&nbsp;</dd>
	<dt><?php __("created"); ?></dt>
	<dd><?php echo $certificatetype['Certificatetype']['created']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("modified"); ?></dt>
	<dd class="altrow"><?php echo $certificatetype['Certificatetype']['modified']; ?>&nbsp;</dd>
...
<div class="additional actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('edit_certificatetype', true), array('controller' => 'certificatetypes', 'action' => 'edit', $certificatetype['Certificatetype']['id'])); ?></li>
		<li>&nbsp;</li>
