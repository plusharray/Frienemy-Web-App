...
<h2><?php __('server_detail_information'); ?></h2>

<dl>
	<dt class="altrow"><?php __("serverid"); ?></dt>
	<dd class="altrow"><?php echo $server['Server']['serverid']; ?>&nbsp;</dd>
	<dt><?php __("id"); ?></dt>
	<dd><?php echo $server['Server']['id']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("servername"); ?></dt>
	<dd class="altrow"><?php echo $server['Server']['servername']; ?>&nbsp;</dd>
	<dt><?php __("created"); ?></dt>
	<dd><?php echo $server['Server']['created']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("serverurl"); ?></dt>
	<dd class="altrow"><?php echo $server['Server']['serverurl']; ?>&nbsp;</dd>
	<dt><?php __("servertypeid"); ?></dt>
	<dd><?php echo $server['Server']['servertypeid']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("modified"); ?></dt>
	<dd class="altrow"><?php echo $server['Server']['modified']; ?>&nbsp;</dd>
...
<div class="additional actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('edit_server', true), array('controller' => 'servers', 'action' => 'edit', $server['Server']['id'])); ?></li>
		<li>&nbsp;</li>
