<div class="feeddevices view">
<h2><?php __('feeddevice_detail_information'); ?></h2>

<dl>
	<dt class="altrow"><?php __("feeddeviceid"); ?></dt>
	<dd class="altrow"><?php echo $feeddevice['Feeddevice']['feeddeviceid']; ?>&nbsp;</dd>
	<dt><?php __("dateadded"); ?></dt>
	<dd><?php echo $feeddevice['Feeddevice']['dateadded']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("id"); ?></dt>
	<dd class="altrow"><?php echo $feeddevice['Feeddevice']['id']; ?>&nbsp;</dd>
	<dt><?php __("created"); ?></dt>
	<dd><?php echo $feeddevice['Feeddevice']['created']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("dateupdated"); ?></dt>
	<dd class="altrow"><?php echo $feeddevice['Feeddevice']['dateupdated']; ?>&nbsp;</dd>
	<dt><?php __("modified"); ?></dt>
	<dd><?php echo $feeddevice['Feeddevice']['modified']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("enabled"); ?></dt>
	<dd class="altrow"><?php echo $feeddevice['Feeddevice']['enabled']; ?>&nbsp;</dd>
...
<div class="additional actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('edit_feeddevice', true), array('controller' => 'feeddevices', 'action' => 'edit', $feeddevice['Feeddevice']['id'])); ?></li>
		<li>&nbsp;</li>
