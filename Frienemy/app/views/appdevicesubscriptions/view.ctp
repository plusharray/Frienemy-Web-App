<div class="appdevicesubscriptions view">
<h2><?php __('appdevicesubscription_detail_information'); ?></h2>

<dl>
	<dt class="altrow"><?php __("appdevicesubscriptionid"); ?></dt>
	<dd class="altrow"><?php echo $appdevicesubscription['Appdevicesubscription']['appdevicesubscriptionid']; ?>&nbsp;</dd>
	<dt><?php __("dateadded"); ?></dt>
	<dd><?php echo $appdevicesubscription['Appdevicesubscription']['dateadded']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("id"); ?></dt>
	<dd class="altrow"><?php echo $appdevicesubscription['Appdevicesubscription']['id']; ?>&nbsp;</dd>
	<dt><?php __("dateupdated"); ?></dt>
	<dd><?php echo $appdevicesubscription['Appdevicesubscription']['dateupdated']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("created"); ?></dt>
	<dd class="altrow"><?php echo $appdevicesubscription['Appdevicesubscription']['created']; ?>&nbsp;</dd>
	<dt><?php __("subscriptionenabled"); ?></dt>
	<dd><?php echo $appdevicesubscription['Appdevicesubscription']['subscriptionenabled']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("modified"); ?></dt>
	<dd class="altrow"><?php echo $appdevicesubscription['Appdevicesubscription']['modified']; ?>&nbsp;</dd>
...
<div class="additional actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('edit_appdevicesubscription', true), array('controller' => 'appdevicesubscriptions', 'action' => 'edit', $appdevicesubscription['Appdevicesubscription']['id'])); ?></li>
		<li>&nbsp;</li>
