...
<h2><?php __('device_detail_information'); ?></h2>

<dl>
	<dt class="altrow"><?php __("deviceid"); ?></dt>
	<dd class="altrow"><?php echo $device['Device']['deviceid']; ?>&nbsp;</dd>
	<dt><?php __("id"); ?></dt>
	<dd><?php echo $device['Device']['id']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("devicetoken"); ?></dt>
	<dd class="altrow"><?php echo $device['Device']['devicetoken']; ?>&nbsp;</dd>
	<dt><?php __("created"); ?></dt>
	<dd><?php echo $device['Device']['created']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("dateadded"); ?></dt>
	<dd class="altrow"><?php echo $device['Device']['dateadded']; ?>&nbsp;</dd>
	<dt><?php __("istestdevice"); ?></dt>
	<dd><?php echo $device['Device']['istestdevice']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("modified"); ?></dt>
	<dd class="altrow"><?php echo $device['Device']['modified']; ?>&nbsp;</dd>
	<dt><?php __("devicenotes"); ?></dt>
	<dd><?php echo $device['Device']['devicenotes']; ?>&nbsp;</dd>
...
<div class="additional actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('edit_device', true), array('controller' => 'devices', 'action' => 'edit', $device['Device']['id'])); ?></li>
		<li>&nbsp;</li>
