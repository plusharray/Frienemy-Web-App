<div class="appsubscriptions view">
<h2><?php __('appsubscription_detail_information'); ?></h2>

<dl>
	<dt class="altrow"><?php __("appsubscriptionid"); ?></dt>
	<dd class="altrow"><?php echo $appsubscription['Appsubscription']['appsubscriptionid']; ?>&nbsp;</dd>
	<dt><?php __("id"); ?></dt>
	<dd><?php echo $appsubscription['Appsubscription']['id']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("subscriptionname"); ?></dt>
	<dd class="altrow"><?php echo $appsubscription['Appsubscription']['subscriptionname']; ?>&nbsp;</dd>
	<dt><?php __("created"); ?></dt>
	<dd><?php echo $appsubscription['Appsubscription']['created']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("modified"); ?></dt>
	<dd class="altrow"><?php echo $appsubscription['Appsubscription']['modified']; ?>&nbsp;</dd>
...
<div class="additional actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('edit_appsubscription', true), array('controller' => 'appsubscriptions', 'action' => 'edit', $appsubscription['Appsubscription']['id'])); ?></li>
		<li>&nbsp;</li>
