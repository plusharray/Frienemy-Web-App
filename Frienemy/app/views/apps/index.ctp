...
<h2><?php __('list_of_apps'); ?></h2>

<div id="gridWrapper">
	<table id="datagrid">
		<thead>
			<tr>
				<th class="app appid"><?php echo $this->Paginator->sort('appid'); ?></th>
				<th class="app appname"><?php echo $this->Paginator->sort('appname'); ?></th>
				<th class="app id"><?php echo $this->Paginator->sort('id'); ?></th>
				<th class="app dateadded"><?php echo $this->Paginator->sort('dateadded'); ?></th>
				<th class="app created"><?php echo $this->Paginator->sort('created'); ?></th>
				<th class="app modified"><?php echo $this->Paginator->sort('modified'); ?></th>
		...
		?>
			<tr<?php echo $class;?>>
				<td class="app appid"><?php echo $app['App']['appid']; ?></td>
				<td class="app appname"><?php echo $app['App']['appname']; ?></td>
				<td class="app id"><?php echo $app['App']['id']; ?></td>
				<td class="app dateadded"><?php echo $app['App']['dateadded']; ?></td>
				<td class="app created"><?php echo $app['App']['created']; ?></td>
				<td class="app modified"><?php echo $app['App']['modified']; ?></td>
				<td class="actions">
					<?php echo $this->Html->link(__('view', true), array('controller' => 'apps', 'action' => 'view', $app['App']['id'])); ?>

					<?php echo $this->Html->link(__('edit', true), array('controller' => 'apps', 'action' => 'edit', $app['App']['id'])); ?>

					<?php echo $this->Html->link(__('delete', true), array('controller' => 'apps', 'action' => 'delete', $app['App']['id']), null, sprintf(__('Are you sure you want to delete # %%s ?', true), $app['App']['id'])); ?>
