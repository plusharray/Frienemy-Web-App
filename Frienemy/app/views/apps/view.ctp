<div class="apps view">
<h2><?php __('app_detail_information'); ?></h2>

<dl>
	<dt class="altrow"><?php __("appid"); ?></dt>
	<dd class="altrow"><?php echo $app['App']['appid']; ?>&nbsp;</dd>
	<dt><?php __("appname"); ?></dt>
	<dd><?php echo $app['App']['appname']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("id"); ?></dt>
	<dd class="altrow"><?php echo $app['App']['id']; ?>&nbsp;</dd>
	<dt><?php __("created"); ?></dt>
	<dd><?php echo $app['App']['created']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("dateadded"); ?></dt>
	<dd class="altrow"><?php echo $app['App']['dateadded']; ?>&nbsp;</dd>
	<dt><?php __("modified"); ?></dt>
	<dd><?php echo $app['App']['modified']; ?>&nbsp;</dd>
...
<div class="additional actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('edit_app', true), array('controller' => 'apps', 'action' => 'edit', $app['App']['id'])); ?></li>
		<li>&nbsp;</li>
