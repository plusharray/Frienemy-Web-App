<div class="certificateservers view">
<h2><?php __('certificateserver_detail_information'); ?></h2>

<dl>
	<dt class="altrow"><?php __("certificateserverid"); ?></dt>
	<dd class="altrow"><?php echo $certificateserver['Certificateserver']['certificateserverid']; ?>&nbsp;</dd>
	<dt><?php __("id"); ?></dt>
	<dd><?php echo $certificateserver['Certificateserver']['id']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("created"); ?></dt>
	<dd class="altrow"><?php echo $certificateserver['Certificateserver']['created']; ?>&nbsp;</dd>
	<dt><?php __("modified"); ?></dt>
	<dd><?php echo $certificateserver['Certificateserver']['modified']; ?>&nbsp;</dd>
...
<div class="additional actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('edit_certificateserver', true), array('controller' => 'certificateservers', 'action' => 'edit', $certificateserver['Certificateserver']['id'])); ?></li>
		<li>&nbsp;</li>
