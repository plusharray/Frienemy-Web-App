<div class="certificateservers index">
<h2><?php __('list_of_certificateservers'); ?></h2>

<div id="gridWrapper">
	<table id="datagrid">
		<thead>
			<tr>
				<th class="certificateserver certificateserverid"><?php echo $this->Paginator->sort('certificateserverid'); ?></th>
				<th class="certificateserver id"><?php echo $this->Paginator->sort('id'); ?></th>
				<th class="certificateserver created"><?php echo $this->Paginator->sort('created'); ?></th>
				<th class="certificateserver modified"><?php echo $this->Paginator->sort('modified'); ?></th>
		...
		<?php
		$i = 0;
		foreach ($certificateservers as $certificateserver):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
		?>
			<tr<?php echo $class;?>>
				<td class="certificateserver certificateserverid"><?php echo $certificateserver['Certificateserver']['certificateserverid']; ?></td>
				<td class="certificateserver id"><?php echo $certificateserver['Certificateserver']['id']; ?></td>
				<td class="certificateserver created"><?php echo $certificateserver['Certificateserver']['created']; ?></td>
				<td class="certificateserver modified"><?php echo $certificateserver['Certificateserver']['modified']; ?></td>
				<td class="actions">
					<?php echo $this->Html->link(__('view', true), array('controller' => 'certificateservers', 'action' => 'view', $certificateserver['Certificateserver']['id'])); ?>

					<?php echo $this->Html->link(__('edit', true), array('controller' => 'certificateservers', 'action' => 'edit', $certificateserver['Certificateserver']['id'])); ?>

					<?php echo $this->Html->link(__('delete', true), array('controller' => 'certificateservers', 'action' => 'delete', $certificateserver['Certificateserver']['id']), null, sprintf(__('Are you sure you want to delete # %%s ?', true), $certificateserver['Certificateserver']['id'])); ?>
